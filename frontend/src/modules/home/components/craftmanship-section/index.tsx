      ...
      <div className="content-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            <div className="space-y-4 transform translate-y-8">
              <div className="h-64 bg-luxury-cream/50 overflow-hidden luxury-image-hover">
                <div className="w-full h-full bg-[url('/petha-making-1.jpg')] bg-cover bg-center hover:scale-105 transition-transform duration-700"></div>
              </div>
              <div className="h-48 bg-luxury-cream/50 overflow-hidden luxury-image-hover">
                <div className="w-full h-full bg-[url('/petha-making-2.jpg')] bg-cover bg-center hover:scale-105 transition-transform duration-700"></div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="h-48 bg-luxury-cream/50 overflow-hidden luxury-image-hover">
                <div className="w-full h-full bg-[url('/petha-making-3.jpg')] bg-cover bg-center hover:scale-105 transition-transform duration-700"></div>
              </div>
              <div className="h-64 bg-luxury-cream/50 overflow-hidden luxury-image-hover">
                <div className="w-full h-full bg-[url('/petha-making-4.jpg')] bg-cover bg-center hover:scale-105 transition-transform duration-700"></div>
              </div>
            </div>
          ...
          <div className="pl-0 md:pl-12">
            ...
            <h2 className="font-display text-3xl mb-6">The Art of Petha Making</h2>
            
            <div className="space-y-6 text-luxury-charcoal/80">
              <p className="text-serif-regular leading-relaxed">
                Each petha in our collection represents generations of sweet-making tradition, combining time-honored recipes with modern hygiene standards.
              </p>
              
              <p className="text-serif-regular leading-relaxed">
                Our master sweet makers meticulously prepare every batch, spending hours to transform raw ash gourd into delightful treats of extraordinary taste and texture.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium">Perfect Sweetness</span>
                </div>
              </div>
            </div>
