        ...
        {isPillVisible && !isModalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Dismiss button on the pill with accessible 36x36 touch target */}
              <button
                type="button"
                onClick={handleDismissPill}
                className="w-8 h-8 rounded-full bg-white/15 hover:bg-white/35 flex items-center justify-center text-white/90 hover:text-white transition-colors ml-1"
